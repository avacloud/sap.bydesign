...
public abstract class ServiceCallbackHandler {
  ...
  /**
   * auto generated Axis2 call back method for maintainBundle_V1 method override this method for
   * handling normal response from maintainBundle_V1 operation
   */
  public void receiveResultmaintainBundle_V1(
      com.sap.xi.sapglobal20.global.ProdLotBundleMaintainConfirmationSyncV1Document result) {}

  /**
   * auto generated Axis2 Error handler override this method for handling error response from
   * maintainBundle_V1 operation
   */
  public void receiveErrormaintainBundle_V1(java.lang.Exception e) {}
}

...
public abstract class ServiceCallbackHandler {
  ...
  /**
   * auto generated Axis2 call back method for queryByElements method override this method for
   * handling normal response from queryByElements operation
   */
  public void receiveResultqueryByElements(
      com.sap.xi.sapglobal20.global.IdentifiedStockQueryResponseMessageDocument result) {}

  /**
   * auto generated Axis2 Error handler override this method for handling error response from
   * queryByElements operation
   */
  public void receiveErrorqueryByElements(java.lang.Exception e) {}
}

 ...
 */
public class SiteLogisticsLotMaterialOutputImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.sap.xi.a1s.global.SiteLogisticsLotMaterialOutput
{
    private static final long serialVersionUID = 1L;
    
    public SiteLogisticsLotMaterialOutputImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName SITELOGISTICSLOTMATERIALOUTPUTUUID$0 = 
        new javax.xml.namespace.QName("", "SiteLogisticsLotMaterialOutputUUID");
    private static final javax.xml.namespace.QName TARGETLOGISTICSAREAID$2 = 
    ...
    private static final javax.xml.namespace.QName MATERIALDEVIATIONSTATUSCODE$24 = 
        new javax.xml.namespace.QName("", "MaterialDeviationStatusCode");
    private static final javax.xml.namespace.QName RESTRICTEDINDICATOR$26 = 
        new javax.xml.namespace.QName("", "RestrictedIndicator");
    private static final javax.xml.namespace.QName LINEITEMID$28 = 
        new javax.xml.namespace.QName("", "LineItemID");
    private static final javax.xml.namespace.QName MATERIALINSPECTIONID$30 = 
        new javax.xml.namespace.QName("", "MaterialInspectionID");
    private static final javax.xml.namespace.QName MATERIALINSPECTIONSKIPPINGSTATUSCODE$32 = 
        new javax.xml.namespace.QName("", "MaterialInspectionSkippingStatusCode");
    private static final javax.xml.namespace.QName LOGISTICPACKAGEOUTPUT$34 = 
        new javax.xml.namespace.QName("", "LogisticPackageOutput");
    private static final javax.xml.namespace.QName SERIALNUMBERASSIGNMENT$36 = 
        new javax.xml.namespace.QName("", "SerialNumberAssignment");
    
    
    /**
     * Gets the "SiteLogisticsLotMaterialOutputUUID" element
     */
    public com.sap.xi.ap.common.gdt.UUID getSiteLogisticsLotMaterialOutputUUID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.UUID target = null;
            target = (com.sap.xi.ap.common.gdt.UUID)get_store().find_element_user(SITELOGISTICSLOTMATERIALOUTPUTUUID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public boolean isSetSiteLogisticsLotMaterialOutputUUID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(SITELOGISTICSLOTMATERIALOUTPUTUUID$0) != 0;
        }
    }
     ...
     */
    public void setSiteLogisticsLotMaterialOutputUUID(com.sap.xi.ap.common.gdt.UUID siteLogisticsLotMaterialOutputUUID)
    {
        generatedSetterHelperImpl(siteLogisticsLotMaterialOutputUUID, SITELOGISTICSLOTMATERIALOUTPUTUUID$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "SiteLogisticsLotMaterialOutputUUID" element
     */
    public com.sap.xi.ap.common.gdt.UUID addNewSiteLogisticsLotMaterialOutputUUID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.UUID target = null;
            target = (com.sap.xi.ap.common.gdt.UUID)get_store().add_element_user(SITELOGISTICSLOTMATERIALOUTPUTUUID$0);
            return target;
        }
    }
     ...
     */
    public void unsetSiteLogisticsLotMaterialOutputUUID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(SITELOGISTICSLOTMATERIALOUTPUTUUID$0, 0);
        }
    }
    ...
    public java.lang.String getTargetLogisticsAreaID()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(TARGETLOGISTICSAREAID$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.sap.xi.ap.common.gdt.LogisticsAreaID xgetTargetLogisticsAreaID()
    {
        synchronized (monitor())
        {
            ...
            target = (com.sap.xi.ap.common.gdt.LogisticsAreaID)get_store().find_element_user(TARGETLOGISTICSAREAID$2, 0);
            return target;
        }
    }
    ...
    public boolean isSetTargetLogisticsAreaID()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TARGETLOGISTICSAREAID$2) != 0;
        }
    }
    ...
    public void setTargetLogisticsAreaID(java.lang.String targetLogisticsAreaID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(TARGETLOGISTICSAREAID$2);
            }
    ...
    public void xsetTargetLogisticsAreaID(com.sap.xi.ap.common.gdt.LogisticsAreaID targetLogisticsAreaID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.LogisticsAreaID)get_store().add_element_user(TARGETLOGISTICSAREAID$2);
            }
    ...
    public void unsetTargetLogisticsAreaID()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(TARGETLOGISTICSAREAID$2, 0);
        }
    }
    ...
    public com.sap.xi.ap.common.gdt.DeviationStatusCode.Enum getMaterialDeviationStatusCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(MATERIALDEVIATIONSTATUSCODE$24, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.sap.xi.ap.common.gdt.DeviationStatusCode xgetMaterialDeviationStatusCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.sap.xi.ap.common.gdt.DeviationStatusCode)get_store().find_element_user(MATERIALDEVIATIONSTATUSCODE$24, 0);
            return target;
        }
    }
    ...
    public boolean isSetMaterialDeviationStatusCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MATERIALDEVIATIONSTATUSCODE$24) != 0;
        }
    }
    ...
    public void setMaterialDeviationStatusCode(com.sap.xi.ap.common.gdt.DeviationStatusCode.Enum materialDeviationStatusCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(MATERIALDEVIATIONSTATUSCODE$24);
            }
    ...
    public void xsetMaterialDeviationStatusCode(com.sap.xi.ap.common.gdt.DeviationStatusCode materialDeviationStatusCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.DeviationStatusCode)get_store().add_element_user(MATERIALDEVIATIONSTATUSCODE$24);
            }
    ...
    public void unsetMaterialDeviationStatusCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(MATERIALDEVIATIONSTATUSCODE$24, 0);
        }
    }
    ...
    public boolean getRestrictedIndicator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(RESTRICTEDINDICATOR$26, 0);
            if (target == null)
            {
                return false;
            }
    ...
    public com.sap.xi.ap.common.gdt.Indicator xgetRestrictedIndicator()
    {
        synchronized (monitor())
        {
            ...
            target = (com.sap.xi.ap.common.gdt.Indicator)get_store().find_element_user(RESTRICTEDINDICATOR$26, 0);
            return target;
        }
    }
    ...
    public boolean isSetRestrictedIndicator()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(RESTRICTEDINDICATOR$26) != 0;
        }
    }
    ...
    public void setRestrictedIndicator(boolean restrictedIndicator)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(RESTRICTEDINDICATOR$26);
            }
    ...
    public void xsetRestrictedIndicator(com.sap.xi.ap.common.gdt.Indicator restrictedIndicator)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.Indicator)get_store().add_element_user(RESTRICTEDINDICATOR$26);
            }
    ...
    public void unsetRestrictedIndicator()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(RESTRICTEDINDICATOR$26, 0);
        }
    }
    ...
    public int getLineItemID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(LINEITEMID$28, 0);
            if (target == null)
            {
                return 0;
            }
    ...
    public com.sap.xi.ap.common.gdt.OrdinalNumberValue xgetLineItemID()
    {
        synchronized (monitor())
        {
            ...
            target = (com.sap.xi.ap.common.gdt.OrdinalNumberValue)get_store().find_element_user(LINEITEMID$28, 0);
            return target;
        }
    }
    ...
    public boolean isSetLineItemID()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LINEITEMID$28) != 0;
        }
    }
    ...
    public void setLineItemID(int lineItemID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(LINEITEMID$28);
            }
    ...
    public void xsetLineItemID(com.sap.xi.ap.common.gdt.OrdinalNumberValue lineItemID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.OrdinalNumberValue)get_store().add_element_user(LINEITEMID$28);
            }
    ...
    public void unsetLineItemID()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(LINEITEMID$28, 0);
        }
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.BusinessTransactionDocumentID getMaterialInspectionID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.BusinessTransactionDocumentID target = null;
            target = (com.sap.xi.ap.common.gdt.BusinessTransactionDocumentID)get_store().find_element_user(MATERIALINSPECTIONID$30, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public boolean isSetMaterialInspectionID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(MATERIALINSPECTIONID$30) != 0;
        }
    }
     ...
     */
    public void setMaterialInspectionID(com.sap.xi.ap.common.gdt.BusinessTransactionDocumentID materialInspectionID)
    {
        generatedSetterHelperImpl(materialInspectionID, MATERIALINSPECTIONID$30, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "MaterialInspectionID" element
     */
    public com.sap.xi.ap.common.gdt.BusinessTransactionDocumentID addNewMaterialInspectionID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.BusinessTransactionDocumentID target = null;
            target = (com.sap.xi.ap.common.gdt.BusinessTransactionDocumentID)get_store().add_element_user(MATERIALINSPECTIONID$30);
            return target;
        }
    }
     ...
     */
    public void unsetMaterialInspectionID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MATERIALINSPECTIONID$30, 0);
        }
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.MaterialInspectionSkippingStatusCode.Enum getMaterialInspectionSkippingStatusCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(MATERIALINSPECTIONSKIPPINGSTATUSCODE$32, 0);
            if (target == null)
            {
                return null;
            }
            return (com.sap.xi.ap.common.gdt.MaterialInspectionSkippingStatusCode.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.MaterialInspectionSkippingStatusCode xgetMaterialInspectionSkippingStatusCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.MaterialInspectionSkippingStatusCode target = null;
            target = (com.sap.xi.ap.common.gdt.MaterialInspectionSkippingStatusCode)get_store().find_element_user(MATERIALINSPECTIONSKIPPINGSTATUSCODE$32, 0);
            return target;
        }
    }
     ...
     */
    public boolean isSetMaterialInspectionSkippingStatusCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(MATERIALINSPECTIONSKIPPINGSTATUSCODE$32) != 0;
        }
    }
     ...
     */
    public void setMaterialInspectionSkippingStatusCode(com.sap.xi.ap.common.gdt.MaterialInspectionSkippingStatusCode.Enum materialInspectionSkippingStatusCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(MATERIALINSPECTIONSKIPPINGSTATUSCODE$32);
            }
            target.setEnumValue(materialInspectionSkippingStatusCode);
        }
    }
     ...
     */
    public void xsetMaterialInspectionSkippingStatusCode(com.sap.xi.ap.common.gdt.MaterialInspectionSkippingStatusCode materialInspectionSkippingStatusCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.MaterialInspectionSkippingStatusCode)get_store().add_element_user(MATERIALINSPECTIONSKIPPINGSTATUSCODE$32);
            }
            target.set(materialInspectionSkippingStatusCode);
        }
    }
     ...
     */
    public void unsetMaterialInspectionSkippingStatusCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(MATERIALINSPECTIONSKIPPINGSTATUSCODE$32, 0);
        }
    }
     ...
     */
    public com.sap.xi.a1s.global.SiteLogisticsLotLogisticPackageOutput getLogisticPackageOutput()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.a1s.global.SiteLogisticsLotLogisticPackageOutput target = null;
            target = (com.sap.xi.a1s.global.SiteLogisticsLotLogisticPackageOutput)get_store().find_element_user(LOGISTICPACKAGEOUTPUT$34, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public boolean isSetLogisticPackageOutput()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(LOGISTICPACKAGEOUTPUT$34) != 0;
        }
    }
     ...
     */
    public void setLogisticPackageOutput(com.sap.xi.a1s.global.SiteLogisticsLotLogisticPackageOutput logisticPackageOutput)
    {
        generatedSetterHelperImpl(logisticPackageOutput, LOGISTICPACKAGEOUTPUT$34, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    
    /**
     * Appends and returns a new empty "LogisticPackageOutput" element
     */
    public com.sap.xi.a1s.global.SiteLogisticsLotLogisticPackageOutput addNewLogisticPackageOutput()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.a1s.global.SiteLogisticsLotLogisticPackageOutput target = null;
            target = (com.sap.xi.a1s.global.SiteLogisticsLotLogisticPackageOutput)get_store().add_element_user(LOGISTICPACKAGEOUTPUT$34);
            return target;
        }
    }
     ...
     */
    public void unsetLogisticPackageOutput()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(LOGISTICPACKAGEOUTPUT$34, 0);
        }
    }
     ...
     */
    public com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment[] getSerialNumberAssignmentArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(SERIALNUMBERASSIGNMENT$36, targetList);
            com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment[] result = new com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment[targetList.size()];
     ...
     */
    public com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment getSerialNumberAssignmentArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment target = null;
            target = (com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment)get_store().find_element_user(SERIALNUMBERASSIGNMENT$36, i);
            if (target == null)
            {
     ...
     */
    public int sizeOfSerialNumberAssignmentArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(SERIALNUMBERASSIGNMENT$36);
        }
    }
    
    /**
     * Sets array of all "SerialNumberAssignment" element  WARNING: This method is not atomicaly synchronized.
     */
    public void setSerialNumberAssignmentArray(com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment[] serialNumberAssignmentArray)
    {
        check_orphaned();
        arraySetterHelper(serialNumberAssignmentArray, SERIALNUMBERASSIGNMENT$36);
    }
    
    /**
     * Sets ith "SerialNumberAssignment" element
     */
    public void setSerialNumberAssignmentArray(int i, com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment serialNumberAssignment)
    {
        generatedSetterHelperImpl(serialNumberAssignment, SERIALNUMBERASSIGNMENT$36, i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "SerialNumberAssignment" element
     */
    public com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment insertNewSerialNumberAssignment(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment target = null;
            target = (com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment)get_store().insert_element_user(SERIALNUMBERASSIGNMENT$36, i);
            return target;
        }
    }
     ...
     */
    public com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment addNewSerialNumberAssignment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment target = null;
            target = (com.sap.xi.a1s.global.SiteLogisticsLotSerialNumberAssignment)get_store().add_element_user(SERIALNUMBERASSIGNMENT$36);
            return target;
        }
    }
     ...
     */
    public void removeSerialNumberAssignment(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(SERIALNUMBERASSIGNMENT$36, i);
        }
    }
}

 ...
 */
public class IdentifiedStockTypeCodeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode
{
    private static final long serialVersionUID = 1L;
    
    public IdentifiedStockTypeCodeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, true);
    }
    
    protected IdentifiedStockTypeCodeImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListID xgetListID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListID target = null;
            target = (com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListID)get_store().find_attribute_user(LISTID$0);
            return target;
        }
    }
     ...
     */
    public void xsetListID(com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListID listID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListID)get_store().add_attribute_user(LISTID$0);
            }
            target.set(listID);
        }
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListAgencyID xgetListAgencyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListAgencyID target = null;
            target = (com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListAgencyID)get_store().find_attribute_user(LISTAGENCYID$2);
            return target;
        }
    }
     ...
     */
    public void xsetListAgencyID(com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListAgencyID listAgencyID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListAgencyID)get_store().add_attribute_user(LISTAGENCYID$2);
            }
     ...
     */
    public static class ListIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListID
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class ListAgencyIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.IdentifiedStockTypeCode.ListAgencyID
    {
        private static final long serialVersionUID = 1L;

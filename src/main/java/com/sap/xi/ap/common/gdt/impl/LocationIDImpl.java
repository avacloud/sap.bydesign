...
public class LocationIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.LocationID
{
    ...
    public com.sap.xi.basis.global.AgencyIdentificationCode xgetSchemeAgencySchemeAgencyID()
    {
        synchronized (monitor())
        {
            ...
            target = (com.sap.xi.basis.global.AgencyIdentificationCode)get_store().find_attribute_user(SCHEMEAGENCYSCHEMEAGENCYID$6);
            return target;
        }
    }
    ...
    public void xsetSchemeAgencySchemeAgencyID(com.sap.xi.basis.global.AgencyIdentificationCode schemeAgencySchemeAgencyID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.sap.xi.basis.global.AgencyIdentificationCode)get_store().add_attribute_user(SCHEMEAGENCYSCHEMEAGENCYID$6);
            }

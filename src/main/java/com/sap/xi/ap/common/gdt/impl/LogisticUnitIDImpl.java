 ...
 */
public class LogisticUnitIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.LogisticUnitID
{
    private static final long serialVersionUID = 1L;
    
    public LogisticUnitIDImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, true);
    }
    
    protected LogisticUnitIDImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeID xgetSchemeID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeID target = null;
            target = (com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeID)get_store().find_attribute_user(SCHEMEID$0);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeID(com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeID schemeID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeID)get_store().add_attribute_user(SCHEMEID$0);
            }
            target.set(schemeID);
        }
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeVersionID xgetSchemeVersionID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeVersionID target = null;
            target = (com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeVersionID)get_store().find_attribute_user(SCHEMEVERSIONID$2);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeVersionID(com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeVersionID schemeVersionID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeVersionID)get_store().add_attribute_user(SCHEMEVERSIONID$2);
            }
     ...
     */
    public com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeAgencyID xgetSchemeAgencyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeAgencyID target = null;
            target = (com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeAgencyID)get_store().find_attribute_user(SCHEMEAGENCYID$4);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeAgencyID(com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeAgencyID schemeAgencyID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeAgencyID)get_store().add_attribute_user(SCHEMEAGENCYID$4);
            }
     ...
     */
    public static class SchemeIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeID
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class SchemeVersionIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeVersionID
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class SchemeAgencyIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.LogisticUnitID.SchemeAgencyID
    {
        private static final long serialVersionUID = 1L;

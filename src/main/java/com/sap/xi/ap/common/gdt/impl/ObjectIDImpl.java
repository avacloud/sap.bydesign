...
public class ObjectIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.ObjectID
{
     ...
     */
    public com.sap.xi.basis.global.AgencyIdentificationCode.Enum getSchemeAgencySchemeAgencyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.sap.xi.basis.global.AgencyIdentificationCode xgetSchemeAgencySchemeAgencyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.basis.global.AgencyIdentificationCode target = null;
            target = (com.sap.xi.basis.global.AgencyIdentificationCode)get_store().find_attribute_user(SCHEMEAGENCYSCHEMEAGENCYID$8);
            return target;
        }
    }
     ...
     */
    public void setSchemeAgencySchemeAgencyID(com.sap.xi.basis.global.AgencyIdentificationCode.Enum schemeAgencySchemeAgencyID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            target.setEnumValue(schemeAgencySchemeAgencyID);
        }
    }
     ...
     */
    public void xsetSchemeAgencySchemeAgencyID(com.sap.xi.basis.global.AgencyIdentificationCode schemeAgencySchemeAgencyID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.basis.global.AgencyIdentificationCode)get_store().add_attribute_user(SCHEMEAGENCYSCHEMEAGENCYID$8);
            }

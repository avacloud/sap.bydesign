 ...
 */
public class PartyIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.PartyID
{
    private static final long serialVersionUID = 1L;
    
    public PartyIDImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, true);
    }
    
    protected PartyIDImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.PartyID.SchemeID xgetSchemeID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.PartyID.SchemeID target = null;
            target = (com.sap.xi.ap.common.gdt.PartyID.SchemeID)get_store().find_attribute_user(SCHEMEID$0);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeID(com.sap.xi.ap.common.gdt.PartyID.SchemeID schemeID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.PartyID.SchemeID)get_store().add_attribute_user(SCHEMEID$0);
            }
            target.set(schemeID);
        }
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.PartyID.SchemeAgencyID xgetSchemeAgencyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.PartyID.SchemeAgencyID target = null;
            target = (com.sap.xi.ap.common.gdt.PartyID.SchemeAgencyID)get_store().find_attribute_user(SCHEMEAGENCYID$2);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeAgencyID(com.sap.xi.ap.common.gdt.PartyID.SchemeAgencyID schemeAgencyID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.PartyID.SchemeAgencyID)get_store().add_attribute_user(SCHEMEAGENCYID$2);
            }
     ...
     */
    public com.sap.xi.ap.common.gdt.PartyID.SchemeAgencySchemeID xgetSchemeAgencySchemeID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.PartyID.SchemeAgencySchemeID target = null;
            target = (com.sap.xi.ap.common.gdt.PartyID.SchemeAgencySchemeID)get_store().find_attribute_user(SCHEMEAGENCYSCHEMEID$4);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeAgencySchemeID(com.sap.xi.ap.common.gdt.PartyID.SchemeAgencySchemeID schemeAgencySchemeID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.PartyID.SchemeAgencySchemeID)get_store().add_attribute_user(SCHEMEAGENCYSCHEMEID$4);
            }
     ...
     */
    public static class SchemeIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.PartyID.SchemeID
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class SchemeAgencyIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.PartyID.SchemeAgencyID
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class SchemeAgencySchemeIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.PartyID.SchemeAgencySchemeID
    {
        private static final long serialVersionUID = 1L;

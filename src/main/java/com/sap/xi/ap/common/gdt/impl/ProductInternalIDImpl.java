 ...
 */
public class ProductInternalIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.ProductInternalID
{
    private static final long serialVersionUID = 1L;
    
    public ProductInternalIDImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, true);
    }
    
    protected ProductInternalIDImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.ProductInternalID.SchemeID xgetSchemeID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.ProductInternalID.SchemeID target = null;
            target = (com.sap.xi.ap.common.gdt.ProductInternalID.SchemeID)get_store().find_attribute_user(SCHEMEID$0);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeID(com.sap.xi.ap.common.gdt.ProductInternalID.SchemeID schemeID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.ProductInternalID.SchemeID)get_store().add_attribute_user(SCHEMEID$0);
            }
            target.set(schemeID);
        }
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.ProductInternalID.SchemeAgencyID xgetSchemeAgencyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.ProductInternalID.SchemeAgencyID target = null;
            target = (com.sap.xi.ap.common.gdt.ProductInternalID.SchemeAgencyID)get_store().find_attribute_user(SCHEMEAGENCYID$2);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeAgencyID(com.sap.xi.ap.common.gdt.ProductInternalID.SchemeAgencyID schemeAgencyID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.ProductInternalID.SchemeAgencyID)get_store().add_attribute_user(SCHEMEAGENCYID$2);
            }
     ...
     */
    public static class SchemeIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.ProductInternalID.SchemeID
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class SchemeAgencyIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.ProductInternalID.SchemeAgencyID
    {
        private static final long serialVersionUID = 1L;

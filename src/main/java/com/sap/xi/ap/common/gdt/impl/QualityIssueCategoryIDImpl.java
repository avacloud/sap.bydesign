 ...
 */
public class QualityIssueCategoryIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.QualityIssueCategoryID
{
    private static final long serialVersionUID = 1L;
    
    public QualityIssueCategoryIDImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType, true);
    }
    
    protected QualityIssueCategoryIDImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
    {
        super(sType, b);
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeID xgetSchemeID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeID target = null;
            target = (com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeID)get_store().find_attribute_user(SCHEMEID$0);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeID(com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeID schemeID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeID)get_store().add_attribute_user(SCHEMEID$0);
            }
            target.set(schemeID);
        }
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeAgencyID xgetSchemeAgencyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeAgencyID target = null;
            target = (com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeAgencyID)get_store().find_attribute_user(SCHEMEAGENCYID$2);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeAgencyID(com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeAgencyID schemeAgencyID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeAgencyID)get_store().add_attribute_user(SCHEMEAGENCYID$2);
            }
     ...
     */
    public static class SchemeIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeID
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class SchemeAgencyIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.QualityIssueCategoryID.SchemeAgencyID
    {
        private static final long serialVersionUID = 1L;

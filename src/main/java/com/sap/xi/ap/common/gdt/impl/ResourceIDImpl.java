 ...
 */
public class ResourceIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.ResourceID
{
     ...
     */
    public com.sap.xi.ap.common.gdt.ResourceID.SchemeID xgetSchemeID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.ResourceID.SchemeID target = null;
            target = (com.sap.xi.ap.common.gdt.ResourceID.SchemeID)get_store().find_attribute_user(SCHEMEID$0);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeID(com.sap.xi.ap.common.gdt.ResourceID.SchemeID schemeID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.ResourceID.SchemeID)get_store().add_attribute_user(SCHEMEID$0);
            }
            target.set(schemeID);
        }
    }
     ...
     */
    public com.sap.xi.ap.common.gdt.ResourceID.SchemeAgencyID xgetSchemeAgencyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.sap.xi.ap.common.gdt.ResourceID.SchemeAgencyID target = null;
            target = (com.sap.xi.ap.common.gdt.ResourceID.SchemeAgencyID)get_store().find_attribute_user(SCHEMEAGENCYID$2);
            return target;
        }
    }
     ...
     */
    public void xsetSchemeAgencyID(com.sap.xi.ap.common.gdt.ResourceID.SchemeAgencyID schemeAgencyID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.sap.xi.ap.common.gdt.ResourceID.SchemeAgencyID)get_store().add_attribute_user(SCHEMEAGENCYID$2);
            }
     ...
     */
    public static class SchemeIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.ResourceID.SchemeID
    {
        private static final long serialVersionUID = 1L;
     ...
     */
    public static class SchemeAgencyIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.sap.xi.ap.common.gdt.ResourceID.SchemeAgencyID
    {
        private static final long serialVersionUID = 1L;
